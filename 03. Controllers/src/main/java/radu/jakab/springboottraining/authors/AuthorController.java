...
// annotates all methods with @ResponseBody, making their return value define the body of the HTTP response
@ResponseBody
public class AuthorController {
     ...
     *
     * @param authorDTO a JSON that can be mapped to an Author DTO
